...
class CookieJarIsolationTest {
    ...
    fun `RecreationConfiguration and CampLifeConfiguration build distinct cookie jar instances`() {
        val recreationConfiguration = RecreationConfiguration(baseUrl = "https://www.recreation.gov/api/", ridbBaseUrl = "https://ridb.recreation.gov/api/v1/", ridbApiKey = "test-key")
        val campLifeConfiguration = CampLifeConfiguration(baseUrl = "https://www.camplife.com/api/")
